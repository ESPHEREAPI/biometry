...
class Adherent extends Entity
{
     ...
     * @var float
     *
     * @ORM\Column(name="plafond_assurep", type="float", precision=10, scale=0, nullable=true)
     */
    protected $plafondAssurep;
	
	/**
     * @var float
     *
     * @ORM\Column(name="cons_ap", type="float", precision=10, scale=0, nullable=true)
     */
    protected $consAp;
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="date_enrole", type="datetime", nullable=true)
     */
    protected $dateEnrole;
     ...
     * Set plafondAssurep
     *
     * @param float $plafondAssurep
     *
     * @return Adherent
     */
    public function setPlafondAssurep($plafondAssurep)
    {
     ...
     * @return float
     */
    public function getPlafondAssurep()
    {
        return $this->plafondAssurep;
    }
     ...
     * @return Adherent
     */
    public function setConsAp($consAp)
    {
        $this->consAp = $consAp;
     ...
     * Set dateEnrole
     *
     * @param \DateTime|null $dateEnrole
     *
     * @return Consultation
     */
