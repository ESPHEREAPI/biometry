...
class LignePrestationController extends BackOfficeCommonController
{
    ...
    public function paginationAction()
    {
        ...
        if(empty($error))
        {
            ...
            $peuxValiderLignePrestation = $this->lignePrestationManager->verifierSiPeuxValiderRejeterLigneDentisterie($this->tabListeMenu, $this->numeroOrdre);
            $peuxRejeterLignePrestation = $this->lignePrestationManager->verifierSiPeuxValiderRejeterLigneDentisterie($this->tabListeMenu, $this->numeroOrdre);
            $peuxMettrePrixLignePrestation = $this->lignePrestationManager->verifierSiPeuxMettrePrixLigneDentisterie($this->tabListeMenu, $this->numeroOrdre);
            $peuxEncaisserLignePrestation = $this->lignePrestationManager->verifierSiPeuxEncaisserLigneDentisterie($this->tabListeMenu, $this->numeroOrdre);
            
            
            $peuxDevaliderLignePrestation = $this->lignePrestationManager->verifierSiPeuxValiderRejeterLigneDentisterie($this->tabListeMenu, $this->numeroOrdre);
            $peuxDerejeterLignePrestation = $this->lignePrestationManager->verifierSiPeuxValiderRejeterLigneDentisterie($this->tabListeMenu, $this->numeroOrdre);
...
//                 $jsonTabLignePrestation = json_encode($tabLignePrestation);
                ...
                include_once __DIR__.'/../../view/dentisterie/ligne-prestation/pagination.phtml';
                ...
                try {
                            ...
                            else
                            {
                                ...
                                if(!empty($donneesFormulaire["valeurLignePretation_".$valueIndex]))
                                {
                                    ...
                                    if($afficherMettrePrixLignePrestationButton)
                                    {
                                        ...
                                        elseif(($this->naturePrestation == "dentisterie") && !empty($donneesFormulaire["nbreLignePretation_".$valueIndex]))
                                        {
                                            $lignePrestation->setValeur($donneesFormulaire["valeurLignePretation_".$valueIndex]);
                                            $lignePrestation->setEtat("attente_validation");
                    ...
                    if(!empty($postValues["listeLignePrestationSent"]))
                    {
                        ...
                        if($this->naturePrestation == "dentisterie")
                        {
							...
							$message .= $this->getTranslator("Demande de validation des prestations en dentisterie pour la visite")." ".$consultation->getVisite()->getCodeCourt();	
		            ...
		            $sujet.="Validation"." ".$this->naturePrestation;
            ...
            if($form->isValid())
            {
                ...
                try {
                                ...
                                if(!empty($nouveauEtat))
                                {
                                    if(!empty($donneesFormulaire["valeurModifLignePretation_".$valueIndex]) || ($nouveauEtat == "devalide" || $nouveauEtat == "derejete"))
                                    {
                                        ...
                                        if($afficher)
                                        {
                                            ...
                                            {
                                                if(( $this->naturePrestation=="dentisterie") && !empty($donneesFormulaire["nbreModifLignePretation_".$valueIndex]))
                                                {
                    ...
                    if(!empty($postValues["listeLignePrestationSent"]))
                    {
                        ...
                        if($this->naturePrestation == "dentisterie" )
                        {
						    $message .= $this->getTranslator("Des prestations en dentisterie ont ete validees ou rejete pour la visite")." ".$consultation->getVisite()->getCodeCourt();
                        }
