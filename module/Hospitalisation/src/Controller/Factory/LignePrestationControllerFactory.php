...
use Hospitalisation\Controller\LignePrestationController;
...
class LignePrestationControllerFactory implements FactoryInterface
{
     public function __invoke(ContainerInterface $container, $requestedName, array $options = null) 
     {
          ...
          $lignePrestationForm = $container->get('Hospitalisation\Form\LignePrestationForm');
          $filtreListeLignePrestationForm = $container->get('Hospitalisation\Form\FiltreListeLignePrestationForm');

          $lignePrestationInputFilter = $container->get('Hospitalisation\Form\LignePrestationInputFilter');
