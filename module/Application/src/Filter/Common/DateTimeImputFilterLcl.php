...
class DateTimeImputFilterLcl extends InputFilter {
	
	public $inputFilter;
	
	function __construct ($name, $required=true, $minVal=null, $maxVal=null, $othersValidators=array(), $format='Y-m-d H:i')
	{
		$validators = array();
		if($required)
		{
