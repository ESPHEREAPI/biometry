...
return array(
	...
	'basePath' => 'http://109.228.49.89/biometry/public',
	...
	'email_send_password' => 'ZNSG@!8671259',
...
// 			'url_base_orange_msbt' => "https://webpayment.orange-money.com",
	...
	"sms_mtarget" => array(
        "url" => "http://api-public.mtarget.fr/api-sms.json",
        "api_key"=> "xzPMOPyTXby4Lej",
        "username" => "zenitheinsuranc",
        "password" => "ZdjHV0yL",
        "senderName" => "ZENITHE",
        "serviceId" => "30156",
    ),
    ...
    "sms_nexah" => array(
        ...
        "username" => "info@zenitheinsurance.com",
        "password" => "biometrie2023",
        "senderid" => "ZENITHE",
    ),
//     "sms" => array(
